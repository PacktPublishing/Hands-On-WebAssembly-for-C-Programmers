...
var real_dynCall_iffffi = asm["dynCall_iffffi"];
asm["dynCall_iffffi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iffffi.apply(null, arguments);
};

var real_dynCall_iiffffi = asm["dynCall_iiffffi"];
asm["dynCall_iiffffi"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real_dynCall_iiffffi.apply(null, arguments);
};
